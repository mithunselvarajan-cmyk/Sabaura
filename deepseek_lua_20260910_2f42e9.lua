-- AUTO-REJOIN ON TELEPORT (Infinite Yield style)
local REJOIN_URL = "https://raw.githubusercontent.com/mithunselvarajan-cmyk/Sabaura/refs/heads/main/deepseek_lua_20260910_891a70.lua"
...
do
    ...
    if queueFn then
        ...
        print("[AutoRejoin] Script will re-run after teleport.")
    else
        print("[AutoRejoin] queue_on_teleport not supported by executor.")
    end
end
