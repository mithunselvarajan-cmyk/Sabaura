-- ============================================================
-- PET DETECTOR + WEBHOOK + 20s HOP + UI + JOIN/LEAVE TRIGGER
-- ============================================================
...
local TRIGGER_DELAY = 2   -- 2 seconds after join/leave, then scan

-- ============================================================
-- UI (same style as leaked script)
-- ============================================================
...
-- ============================================================
-- JOIN / LEAVE TRIGGERS (2s delay only)
-- ============================================================
...
-- ============================================================
local function main()
    print("[Hopper] Started. Detecting + hopping every " .. HOP_INTERVAL .. "s.")
    task.wait(8)
